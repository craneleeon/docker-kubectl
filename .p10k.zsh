# Generated by Powerlevel10k configuration wizard on 2022-01-21 at 09:00 UTC.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 16080.
# Wizard options: flat, large icons, lean_8colors, unicode, 24h time, 2 lines, dotted,
# no frame, blue-ornaments, sparse, few icons, concise, transient_prompt,
